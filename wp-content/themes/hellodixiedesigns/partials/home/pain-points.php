...
<section class="bg-dixie-mint">
    <div class="grid md:grid-cols-2 grid-cols-1">
        <div class="p-16 bg-dixie-green md:border-r-3 md:border-b-0 border-b-3 border-dixie-black flex justify-center items-center">
            <div class="max-w-100 flex flex-col items-center py-0 md:py-28 my-12">
                ...
                <p class="font-aglet-sans max-w-113 text-dixie-mint text-center">Of many, that every small business
                    owner should know in order to build a brand that is sustainable and successful.</p>
            </div>
        </div>
        <div class="swiper h-auto w-full">
            <div class="swiper-wrapper">
                <?php if (have_rows('branding_carousel')) : ?>
                    <?php $count = 1; ?>
                    <?php while (have_rows('branding_carousel')) : the_row(); ?>
                        <div class="swiper-slide flex justify-center items-center">
                            <div class="p-16 max-w-3xl flex flex-col items-center">
                                <div class="<?php echo $fact_count; ?>"><?php echo $count; ?></div>
                                <p class="<?php echo $fact_class; ?>"><?php the_sub_field('note'); ?></p>
                            </div>
                        </div>
                        <?php $count++; ?>
                    <?php endwhile; ?>
